...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = _default;\n\n/**\n * 动态插入 CSS 文本样式\n *\n * @param {String} CSS 文本样式\n * @return {Null}\n */\nfunction _default(cssText) {\n  var style = document.createElement('style');\n  style.type = 'text/css';\n  var head = document.head || document.getElementsByTagName('head')[0];\n  style.appendChild(document.createTextNode(cssText));\n  head.appendChild(style);\n}\n\n//# sourceURL=webpack://YYPKG/./core/load-style-text.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = _default;\n\nvar _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs2/regenerator */ \"./node_modules/@babel/runtime-corejs2/regenerator/index.js\"));\n\nvar _promise = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs2/core-js/promise */ \"./node_modules/@babel/runtime-corejs2/core-js/promise.js\"));\n\nvar _stringToDomelement = _interopRequireDefault(__webpack_require__(/*! ./string-to-domelement */ \"./core/string-to-domelement.js\"));\n\nvar _loadStyle = _interopRequireDefault(__webpack_require__(/*! ./load-style */ \"./core/load-style.js\"));\n\nvar _loadScript = _interopRequireDefault(__webpack_require__(/*! ./load-script */ \"./core/load-script.js\"));\n\nvar _loadStyleText = _interopRequireDefault(__webpack_require__(/*! ./load-style-text */ \"./core/load-style-text.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { _promise.default.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new _promise.default(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _default(_x) {\n  return _ref.apply(this, arguments);\n}\n\nfunction _ref() {\n  _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  _regenerator.default.mark(function _callee(testcases) {\n    return _regenerator.default.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            document.body.appendChild((0, _stringToDomelement.default)('<main id=\"mocha\"><i class=\"close\"></i></main>'));\n            (0, _loadStyleText.default)(\"main#mocha {padding-top:45px;position:fixed;top:0;left:0;z-index:999;width:100%;height:100%;margin:0;font-size:14px;background-color:rgba(255, 255, 255, .95);}main#mocha .suite h1 {font-weight:600;}main#mocha i.close {position:absolute;right:20px;bottom:65px;width:40px;height:40px;z-index:1;cursor:pointer;border:3px solid #333}main#mocha i.close::after{position:absolute;right:0;left:0;margin:auto;top:1px;font-size:40px;display:inline-block;content:\\\"\\xD7\\\";color:#333;width:30px;height:30px;line-height:30px;text-align:center}\");\n            document.body.querySelector('main#mocha').addEventListener('click', function (event) {\n              return event.target.parentNode.remove();\n            });\n            _context.next = 5;\n            return (0, _loadStyle.default)('https://unpkg.com/mocha@5.2.0/mocha.css');\n\n          case 5:\n            _context.next = 7;\n            return (0, _loadScript.default)('https://unpkg.com/mocha@5.2.0/mocha.js');\n\n          case 7:\n            _context.next = 9;\n            return (0, _loadScript.default)('https://unpkg.com/chai/chai.js');\n\n          case 9:\n            window.mocha.setup('bdd');\n            _context.t0 = testcases;\n\n            if (!_context.t0) {\n              _context.next = 14;\n              break;\n            }\n\n            _context.next = 14;\n            return testcases();\n\n          case 14:\n            window.mocha.run();\n\n          case 15:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _ref.apply(this, arguments);\n}\n\n//# sourceURL=webpack://YYPKG/./core/mocha.js?");

/***/ }),

/***/ "./core/number-range.js":
/*!******************************!*\
  !*** ./core/number-range.js ***!
  \******************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _defineProperty = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs2/core-js/object/define-property */ \"./node_modules/@babel/runtime-corejs2/core-js/object/define-property.js\"));\n\nvar _assign = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs2/core-js/object/assign */ \"./node_modules/@babel/runtime-corejs2/core-js/object/assign.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; (0, _defineProperty.default)(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/**\n * 资源加载器（image/css/js/svga）\n *\n * @param {Array} url 资源路径数组\n * @param {Number} retry 加载失败时的重试次数\n * @param {Boolean} autoStart 是否在实例化时自动执行start()\n * @return {Function} SourceLoader\n */\nvar loadData = {}; // 事件定义\n\nvar $onEvent = {\n  process: function process() {},\n  complete: function complete() {},\n  error: function error() {}\n};\n\nvar SourceLoader =\n/*#__PURE__*/\nfunction () {\n  function SourceLoader(argument) {\n    _classCallCheck(this, SourceLoader);\n\n    this.init(argument);\n  }\n\n  _createClass(SourceLoader, [{\n    key: \"init\",\n    value: function init(config) {\n      // 默认配置\n      var defaults = {\n        url: [],\n        retry: 3,\n        autoStart: false\n      };\n      this.configs = (0, _assign.default)(defaults, config);\n      this.configs.autoStart && this.start();\n    } // 加载器\n\n  }, {\n    key: \"loader\",\n    value: function loader() {\n      var _this = this;\n\n      var script = function script(url, requestCounts) {\n        var scriptElement = document.createElement('script');\n        scriptElement.src = url;\n        document.getElementsByTagName('head')[0].appendChild(scriptElement);\n\n        _this.loadendEvent(scriptElement, url, 'script', requestCounts);\n      };\n\n      var style = function style(url, requestCounts) {\n        var styleElement = document.createElement('link');\n        styleElement.type = 'text/css';\n        styleElement.rel = 'stylesheet';\n        styleElement.href = url;\n        document.getElementsByTagName('head')[0].appendChild(styleElement);\n\n        _this.loadendEvent(styleElement, url, 'style', requestCounts);\n      };\n\n      var image = function image(url, requestCounts) {\n        var img = new Image();\n        img.src = url;\n\n        _this.loadendEvent(img, url, 'image', requestCounts);\n\n        img = null;\n      };\n\n      var svga = function svga(url, requestCounts) {\n        var xhr = new XMLHttpRequest();\n        xhr.open('GET', url, true);\n        xhr.responseType = 'arraybuffer';\n        xhr.send();\n\n        _this.loadendEvent(xhr, url, 'svga', requestCounts);\n\n        xhr = null;\n      };\n\n      return {\n        script: script,\n        style: style,\n        image: image,\n        svga: svga\n      };\n    }\n    /**\n     * loadend事件处理\n     *\n     * @param {object} node 节点对象\n     * @param {String} url 当前加载的资源url\n     * @param {String} type 资源类型 \"script||style||image||svga\"\n     * @param {Number} requestCounts 当前请求的次数\n     * @return {Funtion} 事件处理函数\n     */\n\n  }, {\n    key: \"loadendEvent\",\n    value: function loadendEvent(node, url, type, requestCounts) {\n      var _this2 = this;\n\n      var error = node.onerror = node.ontimeout = function () {\n        // 加载失败则重试\n        if (requestCounts <= _this2.configs.retry) {\n          requestCounts++;\n\n          _this2.loader()[type](url, requestCounts);\n        } else {\n          return _this2.errorHandle(url);\n        }\n      };\n\n      node.onload = function () {\n        var onload = null;\n\n        if (type !== 'svga') {\n          onload = _this2.successHandle(url);\n          return onload;\n        }\n\n        if (node.status >= 200 && node.status < 300 || node.status === 304) {\n          onload = _this2.successHandle(url);\n          return onload;\n        } else {\n          error();\n        }\n      };\n    }\n  }, {\n    key: \"errorHandle\",\n    value: function errorHandle(url) {\n      console.error(\"\".concat(url, \" load fail\"));\n      $onEvent.error(url);\n      ++loadData.count;\n    }\n  }, {\n    key: \"successHandle\",\n    value: function successHandle(url) {\n      ++loadData.count;\n    }\n  }, {\n    key: \"start\",\n    value: function start() {\n      var _this3 = this;\n\n      var urls = this.configs.url;\n      var urlsArray = [];\n      var tmpCount = 0;\n      typeof urls === 'string' ? urlsArray.push(urls) : urlsArray = urls;\n      urlsArray.forEach(function (item, index) {\n        var extName = item.split('.').pop().toLowerCase();\n\n        if (extName.indexOf('?') > -1) {\n          extName = extName.split('?')[0].toLowerCase();\n        }\n\n        var loaderName = '';\n\n        switch (extName) {\n          case 'css':\n            loaderName = 'style';\n            break;\n\n          case 'js':\n            loaderName = 'script';\n            break;\n\n          case 'jpg':\n          case 'jpeg':\n          case 'png':\n          case 'gif':\n          case 'webp':\n          case 'mbp':\n            loaderName = 'image';\n            break;\n\n          case 'svga':\n            loaderName = 'svga';\n            break;\n        }\n\n        _this3.loader()[loaderName](item, 0);\n      }); // 通过监听loadData.count判断加载状态\n\n      Object.defineProperty(loadData, 'count', {\n        configurable: true,\n        get: function get() {\n          return tmpCount;\n        },\n        set: function set(value) {\n          tmpCount = value;\n\n          if (tmpCount === urlsArray.length) {\n            $onEvent.complete(tmpCount);\n          } else {\n            $onEvent.process(urlsArray.length, tmpCount, urlsArray[tmpCount]);\n          }\n        }\n      });\n    }\n  }, {\n    key: \"$on\",\n    value: function $on(type, fun) {\n      $onEvent[type] = fun;\n    }\n  }]);\n\n  return SourceLoader;\n}();\n\nvar _default = SourceLoader;\nexports.default = _default;\n\n//# sourceURL=webpack://YYPKG/./core/source-loader.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _getUrlParam = _interopRequireDefault(__webpack_require__(/*! ./get-url-param */ \"./core/get-url-param.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n/**\n * 微信刷新页面（不带缓存）\n *\n * @return {Null}\n */\nfunction WXReload() {\n  var searchParamString = window.location.search;\n\n  if (searchParamString) {\n    var wxreloadParam = (0, _getUrlParam.default)('wxreload', window.location.href);\n\n    if (wxreloadParam) {\n      window.location.href = window.location.href.replace(/wxreload=[1-9]\\d+/, \"wxreload=\".concat(new Date().getTime()));\n    } else {\n      window.location.href = \"\".concat(window.location.href, \"&wxreload=\").concat(new Date().getTime());\n    }\n  } else {\n    window.location.href = \"\".concat(window.location.href, \"?wxreload=\").concat(new Date().getTime());\n  }\n}\n\nvar _default = WXReload;\nexports.default = _default;\n\n//# sourceURL=webpack://YYPKG/./core/wx-reload.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _promise = _interopRequireDefault(__webpack_require__(/*! @babel/runtime-corejs2/core-js/promise */ \"./node_modules/@babel/runtime-corejs2/core-js/promise.js\"));\n\nvar _loadScript = _interopRequireDefault(__webpack_require__(/*! ./load-script */ \"./core/load-script.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n/**\n * 微信 JS SDK\n *\n * @param {Object} options 配置选项\n * @return {Promise}\n *\n */\nvar requestSignature = function requestSignature(url) {\n  return new _promise.default(function (resolve, reject) {\n    var xhr = new window.XMLHttpRequest();\n    xhr.open('POST', url, true);\n\n    xhr.onreadystatechange = function () {\n      if (xhr.readyState === window.XMLHttpRequest.DONE && xhr.status === 200) {\n        var data = JSON.parse(xhr.responseText);\n\n        if (data.signature && data.nonceStr) {\n          resolve(data);\n        } else {\n          reject(new Error('service signature error'));\n        }\n      } else if (xhr.readyState === window.XMLHttpRequest.DONE && xhr.status !== 200) {\n        reject(new Error('service error'));\n      }\n    };\n\n    xhr.send();\n  });\n};\n\nvar WXJSSDK = function WXJSSDK() {\n  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n  return new _promise.default(function (resolve, reject) {\n    (0, _loadScript.default)('//res.wx.qq.com/open/js/jweixin-1.4.0.js').then(function () {\n      var successReturn = function successReturn(data) {\n        window.wx.config({\n          debug: options.debug || false,\n          appId: data.appId,\n          timestamp: data.timestamp,\n          nonceStr: data.nonceStr,\n          signature: data.signature,\n          jsApiList: options.jsApiList || ['onMenuShareTimeline', 'onMenuShareAppMessage']\n        });\n        resolve(window.wx);\n      };\n\n      var failReturn = function failReturn(error) {\n        reject(error);\n      };\n\n      if (!options.signatureApiURL) {\n        var url1 = !options.isFIMO ? '//server.yoyiapp.com/wxjssdk/' : '//server.yoyiapp.com/fimo-wxjssdk/';\n        var url2 = !options.isFIMO ? '//server-test.yoyiapp.com/wxjssdk/' : '//server-test.yoyiapp.com/fimo-wxjssdk/';\n        var URL1 = \"\".concat(window.location.protocol === 'http:' ? 'http:' : 'https:').concat(url1);\n        var URL2 = \"\".concat(window.location.protocol === 'http:' ? 'http:' : 'https:').concat(url2);\n        requestSignature(URL1).then(successReturn).catch(function () {\n          requestSignature(URL2).then(successReturn).catch(failReturn);\n        });\n      } else {\n        requestSignature(options.signatureApiURL).then(successReturn).catch(failReturn);\n      }\n    });\n  });\n};\n\nWXJSSDK.share = function (_ref) {\n  var title = _ref.title,\n      desc = _ref.desc,\n      _ref$link = _ref.link,\n      link = _ref$link === void 0 ? window.location.href : _ref$link,\n      imgUrl = _ref.imgUrl;\n  WXJSSDK().then(function (wx) {\n    wx.ready(function () {\n      wx.onMenuShareTimeline({\n        title: title,\n        desc: desc,\n        link: link,\n        imgUrl: imgUrl\n      });\n      wx.onMenuShareAppMessage({\n        title: title,\n        desc: desc,\n        link: link,\n        imgUrl: imgUrl\n      });\n    });\n  });\n};\n\nWXJSSDK.FIMOShare = function (_ref2) {\n  var title = _ref2.title,\n      desc = _ref2.desc,\n      _ref2$link = _ref2.link,\n      link = _ref2$link === void 0 ? window.location.href : _ref2$link,\n      imgUrl = _ref2.imgUrl;\n  WXJSSDK({\n    isFIMO: true\n  }).then(function (wx) {\n    wx.ready(function () {\n      wx.onMenuShareTimeline({\n        title: title,\n        desc: desc,\n        link: link,\n        imgUrl: imgUrl\n      });\n      wx.onMenuShareAppMessage({\n        title: title,\n        desc: desc,\n        link: link,\n        imgUrl: imgUrl\n      });\n    });\n  });\n};\n\nvar _default = WXJSSDK;\nexports.default = _default;\n\n//# sourceURL=webpack://YYPKG/./core/wxjssdk.js?");
